...
async def handle_request(request: Request):
    ...
    intent_handler_dict = {
        ...
        'track.order - context: order-tracking': track_order
    }
...
def track_order(parameters: dict, session_id: str):
    print("Received Parameters:", parameters)  # Debugging statement

    # Extract order ID from the correct key
    order_id = parameters.get('number')  # Use 'number' instead of 'order_id'
